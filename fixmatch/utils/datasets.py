# code adapted from https://github.com/UCSC-REAL/cifar-10-100n/ and https://github.com/kekmodel/FixMatch-pytorch/tree/master
import errno
import hashlib
import math
import os
...
def x_u_split(args, labels):
    ...
    elif args.num_labeled < args.batch_size:
        num_expand_x = math.ceil(args.batch_size * 2 / args.num_labeled)
        labeled_idx = np.hstack([labeled_idx for _ in range(num_expand_x)])
