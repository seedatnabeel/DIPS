...
def run_pseudo(
    ...
    pseudo_labeling_scores_vanilla = pseudo_labeling_model.test_y_values
    ...
    pseudo_labeling_scores_dips_full = pseudo_labeling_model.test_y_values
    ...
    artifacts["vanilla"] = {
        ...
        "scores": pseudo_labeling_scores_vanilla,
    }
    artifacts["begin"] = {
    ...
    artifacts["full"] = {
        ...
        "data": data_full,
        "models": models_full,
        "scores": pseudo_labeling_scores_dips_full,
    }
    artifacts["partial"] = {
...
def run_UPS(
    ...
    ups_scores_vanilla = ups_model.test_y_values
    ...
    ups_scores_dips_full = ups_model.test_y_values
...
def run_FlexMatch(
    ...
    flex_scores_vanilla = flex_model.test_y_values
    ...
    flex_scores_dips_full = flex_model.test_y_values
...
def run_SLA(
    ...
    sla_scores_vanilla = sla_model.test_y_values
    ...
    sla_scores_dips_full = sla_model.test_y_values
...
def run_CSA(
    ...
    csa_scores_vanilla = csa_model.test_y_values
    ...
    csa_scores_dips_full = csa_model.test_y_values
