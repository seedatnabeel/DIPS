...
from baseline_functions_sweep import *
...
def run_baselines(
    ...
    dips_xthresh_orig = deepcopy(dips_xthresh)
    ...
    for i in tqdm(range(numTrials)):
        try:
            ...
            # Add metadata to results for wandb log
            results["dataset"] = dataset_name
            results["x_thresh"] = dips_xthresh_orig
            results["y_thresh"] = dips_ythresh
            results["num_trials"] = numTrials
            results["seed"] = seed_orig
            results["prop_data"] = prop_data
            results["prop_lab"] = prop_lab
            ...
            results["fully_supervised_y_scores"] = fully_supervised_y_scores
            ...
            results["fully_supervised_easy_y_scores"] = fully_supervised_easy_y_scores
            ...
            results["supervised_y_scores"] = supervised_y_scores
            ...
            results["supervised_easy_y_scores"] = supervised_easy_y_scores
            ...
            if "UPS" in algorithm_list:
                ...
                results["ups"] = {
                    ...
                    "vanilla_scores": artifacts["vanilla"]["scores"],
                    "dips_begin": ups_acc_dips_begin,
                    "dips_full": ups_acc_dips_full,
                    "dips_full_scores": artifacts["full"]["scores"],
